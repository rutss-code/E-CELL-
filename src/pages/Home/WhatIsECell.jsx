    ...
    >
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-0">
        <div className="flex flex-col justify-start items-center w-full">
          ...
          >
            Entrepreneurship Cell (E-Cell) of Datta Meghe College of Engineering is a student-driven
            community dedicated to promoting innovation, creativity, and the spirit of
            entrepreneurship. It serves as a platform where students can learn, network, and turn
            ideas into successful ventures through workshops, competitions, mentorship, and industry
            collaborations.
          </p>
          ...
          >
            <div className="flex flex-col sm:flex-row justify-between items-start w-full max-w-[88%] mx-auto gap-8 sm:gap-0">
              ...
              <div
                className="text-center w-full sm:w-[22%] self-center"
                ref={headsCounter?.elementRef}
              >
                <p
              ...
              <div
                className="text-center w-full sm:w-[22%] self-end"
                ref={membersCounter?.elementRef}
              >
                <p
                  className="text-[24px] sm:text-[32px] md:text-[40px] lg:text-3xl font-bold leading-[30px] sm:leading-[40px] md:leading-[50px] lg:leading-3xl text-text-light transition-all duration-300"
                  style={{ fontFamily: 'Oxygen' }}
                >
                  {membersCounter?.displayValue}
                  <br />
                  MEMBERS
                </p>
              </div>
